...
from trading.strategies.ParabolicSARMTFStrategy import ParabolicSARMTFStrategy
...
class ParabolicSARMTFStrategyFactory:
    """
    Constructs a parabolic SAR multi time frame strategy based on the desired candle length
    """
    ...
    def get_strategies(self, name):
        """
        Get parabolic SAR strategy for each applicable symbol with the desired candle length for multiple time frames
        ...
        for symbol in symbols:
            strategy_workers.append(self.get_strategy_runner(ParabolicSARMTFStrategy(self.kite, symbol,
                                                                                     orders=self.orders,
                                                                                     db_path=self.db_path,
                                                                                     candle_interval_lt=self.candle_interval_lt,
                                                                                     candle_interval_ht=self.candle_interval_ht,
